...
import '../styles/VideoSGuru.css'

const VideoSGuru = () => {

  return (
    <div className='videoSGuru'>
      <Container>
        <h1 className="title mb-5 d-flex justify-content-center">Видео с Гуру</h1>
