...
import { Container, Carousel, Button, Accordion } from 'react-bootstrap'
    ...
    <Container>
      ...
      <Accordion >
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            <h6 className='text-muted'> <b>Как я пришла к йоге!</b> <br />
      ...
      <Button className='flat-btn' variant='flat' onClick={() => navigate('/basicrules')}>Основные положения хатха йоги</Button> */}
    </Container>
  )
}
