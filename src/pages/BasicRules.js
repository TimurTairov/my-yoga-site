  ...
  return (
    <Container>
      ...
      <h5 className='text-muted'>
        ...
        Он позволяет практикующему закрепиться в йоге и не сбиться с пути самопознания.<br />
        <br />
        ...
        Мы ведь не знаем какие внутренние процессы в этот момент могут у них происходить.<br />
        <br />
        ...
        Поэтому, это очень важный метод, который нельзя игнорировать в йоге.<br />
        <br />
        В противовес методу Энергии, есть метод Сознания, в котором культивируется преодоление себя и аскетичное выполнение асан и упражнений йоги.<br />
        <br />
        ...
        Метод Сознания позволяет сделать существенный прорыв в йоге, развивает силу воли и приближает йогина к достижению поставленных целей.<br />
        <br />
        Насилие в йоге неэффективно. В том числе и над собой. Ахимса прежде всего.<br />
        <br />
        Мы исключаем все крайности в практике.
        С одной стороны, ленность, инертность и сонливость в асанах, с другой стороны - сверхусилие, чрезмерную нагрузку и крайне болезненные ощущения в теле.<br />
        <br />
      ...
      <h5 className='text-muted'>
        ...
        Радость от выполнения позы, радость от преодоления себя, радость от отдыха.<br />
        <br />
        Аутентичный подход в практике йоге предполагает длительное время нахождения в асанах.
        ...
        Более 15-20 минут практикуют мастера йоги.<br />
        <br />
        ...
        Естественно, после каждой выполненной позы необходим небольшой отдых.<br />
        <br />
        ...
        Или можно выполнить облегченный вариант позы, при необходимости. Вообще, не стоит стесняться делать более простые вариации позы.<br />
        <br />
        ...
        Опытные йогины могут добавлять Атма Вичару или Чистое видение.<br />
        <br />
        ...
        Вы же ими не затронуты. Никак не реагируйте на потоки мыслей, не взаимодействуйте с ними. Формируйте в себе позицию отрешенного, не затронутого зрителя.<br />
        <br />
        В первую очередь, это необходимо для того, чтобы научиться чувствовать и ощущать границы возможностей своего тела, не допускать крайние болезненные ощущения.
        Также это способствует повышению уровня концентрации и подготавливает йогина к более тонким практикам, таким как медитация, визуализация, созерцание.<br />
        <br />
        ...
        С первыми результатами в йоге, ваша вера и уверенность сильно возрастут. Дальше будет легче.<br />
        <br />
