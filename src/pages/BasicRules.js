...
import '../styles/BasicRules.css'

const BasicRules = () => {
  return (
    <div className='basic-rules'>
      <Container>
        <h1 className="title mb-5 d-flex justify-content-center">Хатха йога. Основные положения.</h1>
        ...
        <Image
          ...
          className='basic-rules-gif mt-4 mb-4'
        />
        ...
        <div className='d-flex justify-content-between mt-4'>
          <Image src={suryaNamaskar} className='basic-rules-gif-2' />
          <Image src={kovrik} className='basic-rules-gif-2' />
        </div>
